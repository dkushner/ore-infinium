...
Camera::Camera()
{
    ...
    Debug::log(Debug::Area::ClientRenderer) << "camera init, screen at width: " << Settings::instance()->screenResolutionWidth << " height: " << Settings::instance()->screenResolutionHeight;
